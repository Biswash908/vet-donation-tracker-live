              ...
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="text-[#0f172b] font-semibold">${parseFloat(editedCase.estimated_cost).toFixed(2)}</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-[#45556c]">Amount Paid:</span>
                    <span className="text-[#16a34a] font-semibold">${totalDonated.toFixed(2)}</span>
                  </div>
                  <div className="flex justify-between text-sm pt-2 border-t border-[#e2e8f0]">
                    ...
                    <span className="text-[#155dfc] font-bold">${remaining > 0 ? remaining.toFixed(2) : '0.00'}</span>
                  </div>
                </div>
